...
module.exports = {
  ...
  app_version: "v1.0.0",
  // laf后台服务地址
  laf_url: 'https://e1fj68.laf.run',
  // laf后台服务地址（微信开发工具中），一般和上面laf_url一致就好
  laf_dev_url: 'https://e1fj68.laf.run',
  ...
  science_imgs: [
    ...
    "https://oss.laf.run/e1fj68-cat/%E7%A7%91%E6%99%AE1.png",
    // "https://cos.ap-guangzhou.myqcloud.com/maopu-1251740905/系统/科普2.png",
    "https://oss.laf.run/e1fj68-cat/%E7%A7%91%E6%99%AE2.png",
    // "https://cos.ap-guangzhou.myqcloud.com/maopu-1251740905/系统/科普3.png",
    "https://oss.laf.run/e1fj68-cat/%E7%A7%91%E6%99%AE3.png",
    // "https://cos.ap-guangzhou.myqcloud.com/maopu-1251740905/系统/科普4.png",
    "https://oss.laf.run/e1fj68-cat/%E7%A7%91%E6%99%AE4.png",
    // "https://cos.ap-guangzhou.myqcloud.com/maopu-1251740905/系统/科普5.png"
    "https://oss.laf.run/e1fj68-cat/%E7%A7%91%E6%99%AE5.png"
  ],

  // 赞赏码图片
  reward_img: "https://oss.laf.run/e1fj68-cat/_cgi-bin_mmwebwx-bin_webwxgetmsgimg__&MsgID=7421492284891596167&skey=@crypt_e07f1d7b_cfbeedec32bbcc737a7ea9206c31e0a8&mmweb_appid=wx_webfilehelper.jpg",
  // 新猫问卷图片
  feedback_wj_img: "https://oss.laf.run/e1fj68-cat/%E6%96%B0%E7%8C%AB%E9%97%AE%E5%8D%B7.png",
  // 小程序菊花码图片
  mpcode_img: "https://oss.laf.run/e1fj68-cat/gh_7d99a81c131a_1280.jpg",

  // 徽章排行榜的数量榜logo
  badge_rank_count_img: "https://oss.laf.run/e1fj68-cat/badge_rank_count.png",
  // 徽章排行榜的价值榜logo
  badge_rank_score_img: "https://oss.laf.run/e1fj68-cat/badge_rank_score.png",
  ...
  text: {
    ...
    reward: {
      ...
      reward_tip: "您的投喂及广告收入将用作猫猫救助，每月的收支都会在QQ群里进行公开，感谢您对流浪猫的帮助与支持！\n喵(^･ｪ･^)",
    ...
    feedback: {
      ...
      contract_tip: "有关猫猫信息添加、小程序的建议、照片维权、猫猫领养咨询等事项，请加相关的qq群留言",
    },
